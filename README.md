...
* **Motivation:** I found most of public human pose dataset have vague definition of the key points, like shoulder, hip or wrist, which have limited value for the application of pose detector in a ergonomics or biomechanics perspective. Hopefully, this 'novel' dataset could contribute the futher application of computer vision in ergo community.
## Code
