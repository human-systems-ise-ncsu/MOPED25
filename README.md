...
* **Usage:** 
  ...
  3. The following graph shows the data structure of a single trial of marker data. You can also run though the file 'basic_functions.m' block by block for the details. 
